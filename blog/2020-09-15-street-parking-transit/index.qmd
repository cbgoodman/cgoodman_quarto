...
tibble::tribble(
  ...
  gt::fmt_integer(columns = c(Rank)) |>
  gt::fmt_number(columns = c(Pop17), decimals = 0, use_seps = TRUE) |>
  gt::fmt_currency(columns = c(MonthlyParkingCost, MonthlyTransitPass)) |>
  gt::sub_missing(columns = c(MonthlyTransitPass), missing_text = "-")
