...
categories: 
    ...
    - urban
    - cities
description: "I recently had the pleasure of writing a blog post for the London School of Economic’s US Centre Blog. It covers a recent publication in the *Journal of Urban Affairs* on the implications of local government structure on long-run economic growth in the US metropolitan areas. See below for the full text of the post as well as a link to the original."
image: https://blogsmedia.lse.ac.uk/blogs.dir/58/files/2021/11/New-blog-image-test-4.png
format:
  html: 
...
![**Figure 1 – Population growth, 1960-2000**](../../files/img/popgrow-coeff.png){fig-align="center"}
...
![**Figure 2 – Regional differences**](../../files/img/popgrow-coeff-region.png){fig-align="center"}
