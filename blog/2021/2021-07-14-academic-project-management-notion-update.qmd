...
date: "2021-07-14"
description: "About a year ago, I wrote a small post about how I use <strong>Notion</strong> as a project management tool. I didn't really expect it to be as popular as it is, but I also didn't expect myself to change too much about the process either. It was working. Fast forward one, sort of over, but not really pandemic later. Things have certainly changed, sort of. This post is meant to explain some of those changes and to provide a template for anyone who wants to give this a spin."
categories: 
    - technology
    - project management
---
...
![Manuscript 1 Metadata](../../files/img/notion-update-ms-1.png){fig-align="center"}
...
![Manuscript 1 Content](../../files/img/notion-update-ms-2.png){fig-align="center"}
...
![Manuscript 1 Reviews](../../files/img/notion-update-ms-3.png){fig-align="center"}
...
![The All Active Projects view](../../files/img/notion-update-1.png){fig-align="center"}
...
![The Conference Papers view](../../files/img/notion-update-3.png){fig-align="center"}
...
![The All Active Projects view](../../files/img/notion-update-2.png){fig-align="center"}
...
![All in-process manuscripts in the Manuscript Status database](notion-update-status.png){fig-align="center"}
